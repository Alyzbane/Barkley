...
def show_results_view():
    if "predictions" not in st.session_state or "image" not in st.session_state:
    ...
    with predictions_col:
        if predictions:
            ...
            with tab1:
                ...
                view_datasets(
                    datasets_by_scientific_name[top_pred['label']],
            ...
            with tab2:
                if len(predictions) > 2:
                    ...
                    for pred in predictions[1:]:
                        with st.expander(label=f"**{pred['label']}**"):
                            view_datasets(
                                datasets_by_scientific_name[pred['label']],
